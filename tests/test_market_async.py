...
class TestETradeMarket:
    ...
    async def test_look_up_product(self, httpx2_mock):
    ...
    async def test_get_quote(self, httpx2_mock):
        market = ETradeMarket("key", "secret", "token", "token_secret", dev=True)
    ...
    async def test_get_option_chains(self, httpx2_mock):
        market = ETradeMarket("key", "secret", "token", "token_secret", dev=True)
        ...
        # httpx2_mock with params matching
